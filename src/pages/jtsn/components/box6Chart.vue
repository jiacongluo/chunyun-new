...
export default {
    ...
    methods: {
        ...
        init () {
            if (this.type === '来源') {
                this.theKey = 'originAreaName'
            }
            if (this.type === '去向') {
                this.theKey = 'toAreaName'
            }
        ...
        handleData () {
            ...
            let xData = []
            let sData = []
            for (const theDatum of theData) {
                xData.push(theDatum[this.theKey])
                // sData.push(theDatum['travelerValue'])
                sData.push(this.utils.toPercent(theDatum['travelerZb'],2))
            }
            // debugger
