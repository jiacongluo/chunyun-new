export default function PlacePointView(theMap) {
...
PlacePointView.prototype.MoveToPoint = function (lntlat, maxZoom, deviation) {
...
PlacePointView.prototype.ReturnDefualt = function (defaultZoom) {
  ...
  var lntlat;
  var center = window.defaultCenter
    // debugger

    lntlat = new AMap.LngLat(center);
  var thePitchTimer = window.setInterval(function () {
