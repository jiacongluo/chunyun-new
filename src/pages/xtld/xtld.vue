...
&nbsp;
                    ...
                    <span class="title" @click="paiban2Visible=true" style="display: none">
                    广东省春运工作联系方式
                </span>
                </div>
...
&nbsp;
                    ...
                    <span class="title" @click="paiban3Visible=true" style="display: none">
                   地市春运工作联系方式
                </span>
                </div>
            </div>
            <div class="data-box-header-r">
                <dateRangePicker :value.sync="range" :range="true" :allDate="true" :datePickerType="'daterange'"></dateRangePicker>
            </div>
            ...
            <div class="ban-wrap">
                <div v-for="(item,index) in panbanList" class="item-ban" v-if="displayIndex+7>index&&displayIndex<=index">
                    <div class="title">
                        <!--12月14日（周二）-->
        ...
        <div class="part part-2">
            ...
            <div class="tab-titles">
                ...
                <!--协调任务接收单-->
                <!--</div>-->
                <div :class="['tab-title', 'icon1',workflowDirection==0?'selected':'']" @click="workflowDirection=0">
                    协调任务配送单
                </div>
                <div :class="['tab-title', 'icon2',workflowDirection==4?'selected':'']" @click="workflowDirection=4">
                    协调任务接收单
                </div>
            </div>
            <div class="title-btns">
                省交通厅
                <div class="btn" v-if="workflowDirection==0" @click="createWorkflow()">
                    新建
                </div>
            ...
            <div :class="['right-part','selected'+workType]">
...
<script>
    ...
    export default {
        ...
        watch: {
            workflowDirection(newValue, oldValue){
        ...
        methods: {
            ...
            onDetail() {
                // debugger;
                //https://www.bingolink.biz/pacx/adapter.html?type=4&orderType=1&reOrgId=f998709c-fe5d-4ca5-87c2-0e90d90fdef3
                var theUrlValue = "https://www.bingolink.biz/pacx/adapter.html?type=4&orderType="+this.workType+"&reOrgId=" + this.selectedFlowDetail.orgId+"&loginId=linkadmin@gmcc&createdBy=43142a64-304e-4376-9160-32db210184bd";
            ...
            createWorkflow() {
                this.showDialog("https://www.bingolink.biz/pacx/adapter.html?type=2&loginId=linkadmin@gmcc");
            },
            showWorkFlow() {
                this.showDialog("https://www.bingolink.biz/pacx/adapter.html?type=1&loginId=linkadmin@gmcc");
            },
            //二级数据
            ...
            async getStatistics(workType) {
                this.part2=[];
                this.part3=[];
                if(this.workflowDirection==2){
                    return;
                }
                let theData = await getData("/api/gmcc/getStatistics", {workType: workType, isReceiver:this.workflowDirection});
                /**
                 {
              "orgId": "3a89bced-910e-4e9d-b75a-d1e46b93d8a8",
              "orgName": "广州",
              "orgType": 1, //1二级部门  2 三级部门
              "dayCount": 0,
              "allCount": 7,
              "completeCount": 0,
              "dealCount": 2,
              "timeoutCount": 5
                ...
                this.part2 = theDataList.filter(m => m.orgType == 1);
                this.part3 = theDataList.filter(m => m.orgType == 2);
            },
            //三级数据
            ...
            async getStatisticsDetail(orgId, orgName, workType,item) {
                ...
                // debugger;
                // let theData = await getData("/api/gmcc/getStatisticsDetail", {orgId: orgId, workType: workType});
                // /**"dayCount": 0,
                //  "workTypeName": "协作单",
                //  "workType": 3,
                //  "allCount": 0,
            ...
            async getHomeDetail() {
                ...
                let theData = await getData("/api/gmcc/getHomeDetail", {
                    isReceiver:this.workflowDirection
                });
