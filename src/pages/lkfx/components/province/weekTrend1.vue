...
<script>
    ...
    export default {
        ...
        * */
                ...
                var theTotalValues=datas.map(m=>m.value.total);
                var theResidentValues=datas.map(m=>m.value.resident);
                ...
                var me=this;
                var theLegends = [
                    {name: '总人口',itemHeight:me.utils.calSize(7, theFontSize), itemWidth:me.utils.calSize(22, theFontSize),
                        height:me.utils.calSize(7, theFontSize), width:me.utils.calSize(22, theFontSize),textStyle: {color: "#D9D9D9", fontSize: me.utils.calSize(14, theFontSize)},icon:'rect'},
                    {name: '常驻人口',itemHeight:me.utils.calSize(7, theFontSize), itemWidth:me.utils.calSize(22, theFontSize),height:me.utils.calSize(7, theFontSize), width:me.utils.calSize(22, theFontSize), textStyle: {color: "#D9D9D9", fontSize:  me.utils.calSize(14, theFontSize)},icon:'rect'},
                    {name: '流动人口',itemHeight:me.utils.calSize(7, theFontSize), itemWidth:me.utils.calSize(22, theFontSize), height:me.utils.calSize(7, theFontSize), width:me.utils.calSize(22, theFontSize),textStyle: {color: "#D9D9D9", fontSize:  me.utils.calSize(14, theFontSize)},icon:'rect'},
                ];
                var theName1 = "总人口";
                var theName2 = "常驻人口";
                var theName3 = "流动人口";
                ...
                var option = {
                    ...
                    xAxis: {
                        ...
                        axisLabel: {
                            ...
                            formatter: function (value, idx) {
                                ...
                                return moment(theDate).format('MM-DD');//theDate.getMonth() +  '月' + theDate.getDate() + "日";
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            // smooth: true,
                            smooth:false,
                            data: theFlowValues.map(function (item) {
                                return (item / 10000).toFixed(2)
                            }),
                            lineStyle: {
                                normal: {
