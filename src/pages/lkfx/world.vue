<template>
    <div class="world-view">
        ...
        <!--</div>-->
        <div class="left-part">
            <earthView :data="showInine?inData:outData"></earthView>
        </div>
        <div class="right-part">
            <div class="item item-1">
                ...
                <div class="body">
                    ...
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(inChannelMap['channel1']*100).toFixed(0)}}%
                        </div>
                    </div>
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(inChannelMap['channel3']*100).toFixed(0)}}%
                        </div>
                    </div>
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(inChannelMap['channel2']*100).toFixed(0)}}%
                        </div>
                    </div>
                    ...
                    <div class="item ">
                        ...
                        <div class="percent">
                            {{(inChannelMap['channel0']*100).toFixed(0)}}%
                        </div>
                    </div>
                </div>
            </div>
            <div class="item item-2">
                ...
                <div class="body">
                    ...
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(outChannelMap['channel1']*100).toFixed(0)}}%
                        </div>
                    </div>
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(outChannelMap['channel3']*100).toFixed(0)}}%
                        </div>
                    </div>
                    ...
                    <div class="item right-border">
                        ...
                        <div class="percent">
                            {{(outChannelMap['channel2']*100).toFixed(0)}}%
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="percent">
                            {{(outChannelMap['channel0']*100).toFixed(0)}}%
                        </div>
                    </div>
            ...
            <div class="item item-3">
                ...
                <div class="body" @mouseover="showInine=true">
                    <tableView :data="inData" :type="1" :direction="1"></tableView>
                </div>
            </div>
            <div class="item item-4">
                ...
                <div class="body" @mouseover="showInine=false">
                    <tableView :data="outData" :type="1" :direction="2"></tableView>
                </div>
            </div>
        </div>
        <div class="number-part">
            <div class="number-item number-item-1">
                <div class="title">国外来源总量</div>
                <div class="number-value"><span
                        class="number yellow-number">{{utils.formatNumAuto(numpart.inNum)}}</span><span
                        class="unit">万人</span>
                </div>
            </div>
            <div class="number-item number-item-2">
                <div class="title">国外去向总量</div>
                <div class="number-value"><span
                        class="number yellow-number">{{utils.formatNumAuto(numpart.outNum)}}</span><span
                        class="unit">万人</span>
                </div>
            </div>
        </div>
...
//todo 更新数字
            ...
            async getForgeinInOutChannel(date) {
                ...
                let theData = await get("/api/lkfx/getForgeinInOutChannel?date=" + date);
            ...
            /*
            * getForgeinInOutMove 境外迁入来源/迁出去向分布
            * */
            async getForgeinInOutMove(date) {
                ...
                let theData = await get("/api/lkfx/getForgeinInOutMove?date=" + date);
                if (theData && theData.data) {
                ...
                this.inData = transform.transformLine(this.inoutMove.inMove, 1, 1, '中国').slice(0,10);
                this.outData = transform.transformLine(this.inoutMove.outMove, 2, 1, '中国').slice(0,10);
            ...
            * */
            async getForgeinInOutNum(date) {
                ...
                let theData = await get("/api/lkfx/getForgeinInOutNum?date=" + date, {});
                if (theData && theData.data) {
