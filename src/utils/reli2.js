...
MapBase.prototype.hideReli2 = function () {
...
MapBase.prototype.showReli = function () {
    if (this.theHeartLayer) {
        // debugger
...
function reqReliData(id, isCLickFloor, originalName) {
    ...
    getData(url, data).then((res) => {
        ...
        mapbase.drawReli(window.postionName, res.data[0]['user_cnt'], originalName);
...
MapBase.prototype.initMapEvent = function () {
    ...
    theMap.on('zoom', function (arg) {
        ...
        var theZoom = theMap.getZoom();
        if (theZoom === 16) {
            me.theHeartLayer&&me.theHeartLayer.setOptions({
                style: {
                    radius: 8,
                    // color: {
                    //     0.5: '#2c7bb6',
            ...
            me.theHeartLayer&&me.theHeartLayer.render()
        }
        if (theZoom >= 17) {
            me.theHeartLayer&&me.theHeartLayer.setOptions({
                style: {
...
MapBase.prototype.CreateHeartLayer = function (zindex) {
    // debugger;
    if (!this.theHeartLayer) {
 ...
 * @param data 人数
 */
MapBase.prototype.drawReli = function (name, data, originName) {
